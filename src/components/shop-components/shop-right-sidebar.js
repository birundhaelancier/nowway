...
import {GetAmenities,GetPropertyType } from '../../components/apiActions/index';
										...
										<div className="row">
											<div className="col-lg-12">
												...
												<div className="ltn__search-widget mb-30">
													<form action="#">
														<input type="text" name="search" onChange={(data)=>setSearch(data.target.value)} value={Search} placeholder="Search your keyword..." />
											...
											<div className="col-xl-6 col-sm-6 col-12">
												<div className="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
													...
													<div className="product-info">
														...
														<h2 className="product-title go-top"><Link to="/product-details">{data.title}</Link></h2>
														<div className="product-img-location go-top">
															<ul>
																<li>
																	<Link to="/contact"><i className="flaticon-pin" /> {data.address}</Link>
																</li>
															</ul>
														</div>
														<ul className="ltn__list-item-2--- ltn__list-item-2-before--- ltn__plot-brief">
															<li><span>{data.bedrooms || 0} </span>
																Bed
															</li>
															<li><span>{data.bathroom || 0} </span>
																Bath
															</li>
															<li><span>3450 </span>
																Square Ft
